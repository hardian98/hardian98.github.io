...
document.querySelectorAll(".label")[2].innerHTML = "Feature";
	...
	*/
	...
	function updateChargeInfo() {
		...
		if (battery.charging) {
			...
			ctx.strokeStyle = "#DDD";
			ctx.stroke();
			customAlert("Charging Detachable");
