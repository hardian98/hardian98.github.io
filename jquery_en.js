...
///////////////
/* Text */
document.querySelectorAll("main")[0].innerHTML = "<div id='loader-wrapper'></div><span id='spanmood'>Battery Mood</span><canvas id='batCanvas' width='2000' height='1000'></canvas><div id='bolt'></div><span id='BatteryLevel'></span><span id='petir'></span><div class='stat'><p id='status'>Count...</p><p id='mengisi'></p></div><marquee behavior='alternate' loop='5' scrolldelay='truespeed' scrollamount='6' id='peringatan'></marquee><span id='pengisian'>Fill in &nbsp;<i id='pengisiancepat' class='fa'></i></span><!----><div class='data' id='tabel' style='margin-top: 65%'><label class='label'>--</label><p id='data'>--</p><p id='data'>--</p><p id='data'>--</p><p id='data'>--</p><p id='data'>--</p><p id='data'>---</p></div><!-- 1 --><div class='data' id='tabel'><label class='label'>--</label><p id='data'>--</p><p id='data'>--</p><p id='data'>--</p><p id='data'>--</p><p id='data'>--</p><p id='data'>---</p></div><!-- 2 --><div class='data' id='tabel'><label class='label'>--</label><br><b class='namaFitur'>--</b><br><label class='switch'><input type='checkbox' onclick='pengisiancepat();this.disabled=true'><span class='slider round'></span></label><br><b class='namaFitur'>--</b><br><label class='switch'><input type='checkbox' onclick='Batteryadaptif();this.disabled=true'><span class='slider round'></span></label><br><b class='namaFitur'>--</b><br><label class='switch'><input type='checkbox' onclick='stabilkantegangan();this.disabled=true'><span class='slider round'></span></label><br><b class='namaFitur'>--</b><br><label class='switch'><input type='checkbox' onclick='murnikanlah();ting();this.disabled=true'><span class='slider round'></span></label><br><!--Memurnikan--><p id='proses'></p><p id='persentase'></p><p id='hasil'></p></div><!--Bersihkan--><div class='data' id='tabel'><label class='label'>--</label><p class='tips'>--</p><p class='tips'>--</p><p class='tips'>--</p><p class='tips'>--</p><p class='tips'>--</p></div><audio src='Battery_adaptif.wav' id='Battery_adaptif' type='audio/wav'></audio><audio src='pengisian_cepat.wav' id='pengisian_cepat' type='audio/wav'></audio><audio src='stabilkan_tegangan.wav' id='stabilkan_tegangan' type='audio/wav'></audio><audio src='ting.mp3' id='ting' type='audio/mp3'></audio>";
document.getElementById("loader-wrapper").innerHTML = "<div id=loader></div><div class='loader-section section-left'><p>Calling Server. . .<div class='progress bg-danger'style=height:4px><div class='progress-bar progress-bar-animated progress-bar-striped bg-danger'style=width:100% aria-valuemax=100 aria-valuemin=0 aria-valuenow=35 role=progressbar></div></div><p>Reading Devices. . .<div class='progress bg-info'style=height:4px><div class='progress-bar progress-bar-animated progress-bar-striped bg-info'style=width:100% aria-valuemax=100 aria-valuemin=0 aria-valuenow=35 role=progressbar></div></div><p>Resource Installation. . .<div class='progress bg-success'style=height:4px><div class='progress-bar progress-bar-animated progress-bar-striped bg-success'style=width:100% aria-valuemax=100 aria-valuemin=0 aria-valuenow=35 role=progressbar></div></div><p>Apply. . .<div class='progress bg-primary'style=height:4px><div class='progress-bar progress-bar-animated progress-bar-striped bg-primary'style=width:100% aria-valuemax=100 aria-valuemin=0 aria-valuenow=35 role=progressbar></div></div></div><div class='loader-section section-right'></div>";
document.querySelectorAll(".label")[0].innerHTML = "Basic Battery Info";
document.querySelectorAll(".label")[1].innerHTML = "Basic Device Info";
document.querySelectorAll(".label")[2].innerHTML = "Fitur";
document.querySelectorAll(".label")[3].innerHTML = "Tips";
document.querySelectorAll("#data")[0].innerHTML = "<i class='material-icons'>battery_full</i> Capacity: <span id='kapasitas'>Count... <i class='fa fa-spinner fa-pulse'></i></span>";
document.querySelectorAll("#data")[1].innerHTML = "<i class='material-icons'>bolt</i> Voltage: <span id='spantegangan'>Count... <i class='fa fa-spinner fa-pulse'></i></span>";
document.querySelectorAll("#data")[2].innerHTML = "<i class='material-icons'>star</i> Technology: <span id='teknologi'>Li-poly</span>";
...
document.querySelectorAll(".namaFitur")[1].innerHTML = "<i class='material-icons'>battery_saver</i> Adaptive Battery";
document.querySelectorAll(".namaFitur")[2].innerHTML = "<i class='material-icons'>insights</i> Stabilize Voltage";
document.querySelectorAll(".namaFitur")[3].innerHTML = "<i class='material-icons'>auto_fix_high</i> Purify";
document.querySelectorAll(".tips")[0].innerHTML = "<bdo class='titletips'>•1. To extend Battery life, use the Adaptive Battery Feature.</bdo><br>Adaptive Battery limits Battery for rarely used apps.<br>Your phone will learn how you use apps over time.";
document.querySelectorAll(".tips")[1].innerHTML = "<bdo class='titletips'>•2. A good temperature is between 28°C - 32°C.</bdo><br>If your cellphone's temperature is at 33°C - 35°C, give your cellphone a break.";
document.querySelectorAll(".tips")[2].innerHTML = "<bdo class='titletips'>•3. Turn off your cell phone at least once a day for 10 - 30 minutes.</bdo><br>This will change your battery calibration to normal.";
...
const mood = [
	...
	{"mood": "Normal <i class='material-icons'>sentiment_dissatisfied</i>"},{"mood": "Normal <i class='material-icons'>sentiment_dissatisfied</i>"},
	{"mood": "Happy <i class='material-icons'>mood</i>"},{"mood": "Happy <i class='material-icons'>mood</i>"},{"mood": "Happy <i class='material-icons'>mood</i>"},{"mood": "Happy <i class='material-icons'>mood</i>"},
]
function moodmath() {
...
/* Tegangan */
const tegangan = [
	{"tegangan": "≤4000 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤4050 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤4050 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤4100 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤4150 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤4150 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤4200 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤4250 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤4250 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤4300 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤4350 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤4350 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3500 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3500 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3500 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3550 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3550 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3600 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3600 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3600 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3650 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3650 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3700 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3700 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3700 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3750 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3750 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3800 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3800 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3800 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3850 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3850 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3900 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3900 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3900 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
	{"tegangan": "≤3950 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},{"tegangan": "≤3950 mV <i class='fa fa-circle-o-notch fa-spin'></i>"},
]
function teganganmath() {
...
*/
const canvas = document.querySelector("#batCanvas");
...
navigator.getBattery().then(function(battery) {
	...
	*/
	...
	function updateLevelInfo() {
		var batteryL = battery.level;
		//alert("Kapasitas Battery: " + battery.level *100 + "%");
	...
	switch (batL) {
		...
		document.querySelector("#peringatan").innerHTML = "It's enough for him to die, not your device! Let's connect the resources.";
		document.querySelector("#sisa").innerHTML = "± 0 - 30 Minutes";
		document.querySelector("#mengisi").innerHTML = "125 Minutes";
		break;
		case 1:
		ctx.lineWidth = 10;
		...
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#peringatan").innerHTML = "Your battery is hungry and needs food, connect resources to feed it.";
		document.querySelector("#sisa").innerHTML = "± 1 Hours";
		document.querySelector("#mengisi").innerHTML = "110 Minutes";
		break;
		case 2:
		ctx.lineWidth = 10;
		...
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#peringatan").innerHTML = "Battery is getting tired of life, connect a power source to revive it.";
		document.querySelector("#sisa").innerHTML = "± 1 - 2 Hours";
		document.querySelector("#mengisi").innerHTML = "95 Minutes";
		break;
		case 3:
		ctx.lineWidth = 10;
		...
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#peringatan").innerHTML = "Good time to charge.";
		document.querySelector("#sisa").innerHTML = "± 2 - 3 Hours";
		document.querySelector("#mengisi").innerHTML = "80 Minutes";
		break;
		case 4:
		ctx.lineWidth = 10;
		...
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#peringatan").innerHTML = "Still fine.";
		document.querySelector("#sisa").innerHTML = "± 4 - 5 Hours";
		document.querySelector("#mengisi").innerHTML = "65 Minutes";
		break;
		case 5:
		ctx.lineWidth = 10;
		...
		//ctx.strokeStyle = "#20B2AA";
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#sisa").innerHTML = "± 6 - 7 Hours";
		document.querySelector("#mengisi").innerHTML = "50 Minutes";
		break;
		case 6:
		ctx.lineWidth = 10;
		...
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#sisa").innerHTML = "± 8 - 9 Hours";
		document.querySelector("#mengisi").innerHTML = "40 Minutes";
		break;
		case 7:
		ctx.lineWidth = 10;
		...
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#sisa").innerHTML = "± 10 - 12 Hours";
		document.querySelector("#mengisi").innerHTML = "30 Minutes";
		break;
		case 8:
		ctx.lineWidth = 10;
		...
		//ctx.strokeStyle = "#1E90FF";
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#sisa").innerHTML = "± 12 - 14 Hours";
		document.querySelector("#mengisi").innerHTML = "20 Minutes";
		break;
		case 9:
		ctx.lineWidth = 10;
		...
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#sisa").innerHTML = "± 15 - 17 Hours";
		document.querySelector("#mengisi").innerHTML = "10 Minutes";
		break;
		case 10:
		ctx.lineWidth = 10;
		...
		//ctx.strokeStyle = "#00BFFF";
		ctx.roundRect(280, 300, 1400, 700, [40]), ctx.stroke();
		document.querySelector("#sisa").innerHTML = "± 18 Hours";
		document.querySelector("#mengisi").innerHTML = "Filled";
		break;
		default:
...
function isicepat() {
	var a;
	a = document.querySelector("#pengisiancepat");
	a.innerHTML = "&#xf244;";
	setTimeout(function () {
		a.innerHTML = "&#xf243;";
	}, 1000);
