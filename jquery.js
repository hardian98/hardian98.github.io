...
document.querySelectorAll("#data")[0].innerHTML = "<i class='material-icons'>battery_full</i> Kapasitas: <span id='kapasitas'>Menghitung... <i class='fa fa-spinner fa-pulse'></i></span>";
document.querySelectorAll("#data")[1].innerHTML = "<i class='material-icons'>bolt</i> Tegangan: <span id='spantegangan'>Menghitung... <i class='fa fa-spinner fa-pulse'></i></span>";
...
document.querySelectorAll("#data")[8].innerHTML = "<i class='material-icons'>memory</i> Perangkat Keras: <span id='hardware'></span> (<span id='cores'></span>)";
